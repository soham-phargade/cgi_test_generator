...
module.exports = async (req, res) => {
    ...
    const prompt = `Generate a CSV file with 10 rows of synthetic data. The CSV should have the following headings: Name, Email, Phone Number. Ensure each row contains fictional but plausible data for each column.`;
